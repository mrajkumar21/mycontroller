...
type TestResourceInterface interface {
	...
	UpdateStatus(ctx context.Context, testResource *v1alpha1.TestResource, opts v1.UpdateOptions) (*v1alpha1.TestResource, error)
...
func (c *testResources) UpdateStatus(ctx context.Context, testResource *v1alpha1.TestResource, opts v1.UpdateOptions) (result *v1alpha1.TestResource, err error) {
	result = &v1alpha1.TestResource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("testresources").
