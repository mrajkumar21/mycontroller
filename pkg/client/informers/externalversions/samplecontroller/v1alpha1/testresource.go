...
import (
	"context"
	samplecontrollerv1alpha1 "mycontroller/pkg/apis/samplecontroller/v1alpha1"
	...
	v1alpha1 "mycontroller/pkg/client/listers/samplecontroller/v1alpha1"
	time "time"
...
func NewFilteredTestResourceInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(
		...
		&samplecontrollerv1alpha1.TestResource{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *testResourceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&samplecontrollerv1alpha1.TestResource{}, f.defaultInformer)
}
